...
function Home() {
  ...
  function getList() {
    axios.get(base_url + "activity-groups?email=dandanismail42@gmail.com")
  ...
  function addActivity(){
    axios.post(base_url + "activity-groups", {
        title: "New Activity",
        email: "dandanismail42@gmail.com",
  ...
  function deleteActivity() {
    axios.delete(base_url + "activity-groups/" + selectedActivity.id)
    .then(function () {
      getList()
    })
    .catch(function (error){
